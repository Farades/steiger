<div id="main_container">
	...
	<div class="philosophy">
		<a href="philosophy.php" data-pjax='pjax_container'>
			...
			<p class="philosophy-desc">
				Наша философия заключается в достижении поставленных целей,  путем взаимовыгодных, порядочных и честных отношений между партнерами.
			</p>
		</a>

		<div class="philosophy-button"></div>
	</div>
	<div class="news">
		<a href="news.php" data-pjax='pjax_container'>
			<p class="last_new">
	...
	<div class="distributors">
		<a href="distributor.php" data-pjax='pjax_container'>
			<p class="distributors-text">
				Ресторанам<br>
				Магазинам<br>
				Компаниям<br>
				Дистрибьюторам
